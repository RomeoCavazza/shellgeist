...
Handles common 7B-model deviations:
- Tag variants: <tool_use>, <tool_request>, <tool_call>, <tool>
- Attribute-based: <tool_request name="run_shell">...</tool_request>
- Bare JSON without outer {}: "command": "ls -la"
"""
